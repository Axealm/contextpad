...
| Gmail | 読み取り専用OAuth、一覧・検索・詳細、紐づけ、保存後の保持、解除を実アカウントで本人確認済み。[受入記録](ai-dlc/19-gmail-live-acceptance.md) |
...
- Gmail正常系7項目は本人確認済み。専用テストアカウントと架空メールで、再接続・権限失効などの追加試験と公開用の実演を行う。
...
機能を増やすことだけが次の目標ではない。Gmail正常系の実接続確認を終え、追加試験・再現性・本人の判断説明を揃える段階に進んでいる。生成AIやAWSを追加する場合も、必要性・費用・権限を再検討し、未実施の経験を記載しない。
